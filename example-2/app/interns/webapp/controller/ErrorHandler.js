sap.ui.define(
	...
	function (UI5Object, MessageBox, Filter, FilterOperator) {
		...
		return UI5Object.extend('ecenta.ims.interns.controller.ErrorHandler', {
			/**
			 * Handles application errors by automatically attaching to the model events and displaying errors when needed.
			 * @class
			 * @param {sap.ui.core.UIComponent} oComponent reference to the app's component
			 * @public
			 * @alias ecenta.ims.interns.controller.ErrorHandler
			 */
			constructor: function (oComponent) {
				var oMessageManager = sap.ui.getCore().getMessageManager(),
					oMessageModel = oMessageManager.getMessageModel(),
					oResourceBundle = oComponent
						.getModel('i18n')
						.getResourceBundle(),
					sErrorText = oResourceBundle.getText('errorText'),
					sMultipleErrors =
						oResourceBundle.getText('multipleErrorsText');
